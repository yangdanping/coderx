...
describe('Home scramble title', () => {
  ...
  it('keeps X gradients and avoids fixed-width title spacing', () => {
    ...
    expect(commonScss).toContain('--coder-x-gradient-start: rgba(143, 235, 135, 0.7)');
    expect(commonScss).toContain('--coder-x-gradient-end: rgba(56, 72, 249, 0.7)');
    expect(commonScss).toContain('--writer-x-gradient-start: rgba(255, 211, 88, 0.82)');
    expect(commonScss).toContain('--writer-x-gradient-end: rgba(235, 106, 44, 0.82)');
    expect(commonScss).toContain('--creator-x-gradient-start: rgba(255, 111, 174, 0.78)');
    expect(commonScss).toContain('--creator-x-gradient-end: rgba(132, 0, 255, 0.76)');
    expect(commonScss).toContain('--builder-x-gradient-start: rgba(0, 240, 255, 0.72)');
    expect(commonScss).toContain('--builder-x-gradient-end: rgba(12, 140, 254, 0.8)');

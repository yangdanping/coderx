<template>
  <div class="login-panel">
    <div class="form-container">
      ...
      <!-- Google OAuth 登录 -->
      <template v-if="isLogin && googleEnabled">
        <div class="oauth-divider">
          <span>或</span>
        </div>
        <el-button class="google-btn" :loading="googleLoading" @click="loginWithGoogle">
...
import { getOAuthStatus, getGoogleAuthUrl } from '@/service/oauth/oauth.request';
